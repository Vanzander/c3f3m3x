            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    ...
                    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url();?>index.php/Sociedades/index">
                            <div class="mr-3">
                            ...
                            <div>
                                <span class="font-weight-bold">DESEO CONSTITUIR UNA SOCIEDAD</span>
                            </div>
                        </a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php print_r($usr['nombre'].' '.$usr['ape_pat']); ?></span>
                        <img class="img-profile rounded-circle"
                            src="<?php echo base_url(); ?>assets/img/undraw_profile.svg">
                        <input type="text" value="<?php print_r($usr['id_usr']); ?>" id='id_usr' hidden />
                    </a>
